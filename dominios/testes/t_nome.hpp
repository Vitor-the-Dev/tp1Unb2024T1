...
class TUNome {
    private:
            const string VALOR_VALIDO = "Nome Válido"; // Definição de constante para evitar número mágico.
            const string VALOR_INVALIDO = "Nome inválido por grande excesso de caracteres."; // Definição de constante para evitar número mágico.
