...
class TUData {
    private:
            const string VALOR_VALIDO = "29-02-24"; // Definição de constante para evitar número mágico.
            const string VALOR_INVALIDO = "31-04-24"; // Definição de constante para evitar número mágico.
